  ...
  <header class="py-3 px-3 px-md-5">
    <div class="container-fluid d-flex align-items-center">
      ...
      <nav class="ms-auto d-none d-md-flex gap-4">
        ...
        <a href="#" class="nav-link-custom">Resume</a>
      </nav>

      <button class="btn d-md-none text-purple fs-3 ms-auto"
              data-bs-toggle="collapse"
              data-bs-target="#mobileMenu">☰</button>
    </div>

    <ul id="mobileMenu" class="collapse list-unstyled mt-3 p-3 rounded"
      ...
      <li><a href="#" class="nav-link-custom">Resume</a></li>
    </ul>
  </header>
</template>
